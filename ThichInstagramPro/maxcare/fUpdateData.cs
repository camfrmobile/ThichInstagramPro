...
namespace maxcare
{
	public class fUpdateData : Form
	{
			...
			try
			{
				...
				case "Notes":
				{
					...
					for (int k = 0; k < main.dtgvAcc.Rows.Count; k++)
					{
						...
						{
							main.SetCellAccount(k, "cGhiChu", text);
						}
					}
					break;
				}
				case "Mail|pass":
				{
					...
					for (int num3 = 0; num3 < main.dtgvAcc.Rows.Count; num3++)
					{
						...
						{
							main.SetCellAccount(num3, "cEmail", text.Split('|')[0]);
							main.SetCellAccount(num3, "cPassMail", text.Split('|')[1]);
						}
					}
					break;
				}
				...
				case "Token":
				{
					...
					for (int num = 0; num < main.dtgvAcc.Rows.Count; num++)
					{
						...
						{
							main.SetCellAccount(num, "cToken", text);
						}
					}
					break;
				}
				case "Password":
				{
					...
					for (int num4 = 0; num4 < main.dtgvAcc.Rows.Count; num4++)
					{
						...
						{
							main.SetCellAccount(num4, "cPassword", text);
						}
					}
					break;
				}
				...
				case "2FA":
				{
					...
					for (int num5 = 0; num5 < main.dtgvAcc.Rows.Count; num5++)
					{
						...
						{
							main.SetCellAccount(num5, "cFa2", text);
						}
					}
					break;
				}
				case "User":
				{
					if (!CommonSQL.UpdateMultiFieldToAccount(list, "email", text))
					{
						break;
					}
					for (int num2 = 0; num2 < main.dtgvAcc.Rows.Count; num2++)
					{
						...
						{
							main.SetCellAccount(num2, "cEmail", text);
						}
					}
					break;
				}
				case "Useragent":
				{
					...
					for (int m = 0; m < main.dtgvAcc.Rows.Count; m++)
					{
						...
						{
							main.SetCellAccount(m, "cUseragent", text);
						}
					}
					break;
				}
				case "Birthday":
				{
					...
					for (int j = 0; j < main.dtgvAcc.Rows.Count; j++)
					{
						...
						{
							main.SetCellAccount(j, "cBirthday", text);
						}
					}
					break;
				}
		...
		private void InitializeComponent()
		{
			...
			cbbTypeUpdate.Items.AddRange(new object[7] { "User", "Password", "2FA", "Cookie", "Useragent", "Proxy", "Notes" });
