...
namespace maxcare
{
	public class fHDNhanTinFollowers : Form
	{
		...
		public fHDNhanTinFollowers(string id_KichBan, int type = 0, string id_HanhDong = "")
		{
			InitializeComponent();
			ChangeLanguage();
			isSave = false;
			...
			string text2 = "Nhă\u0301n tin Followers";
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(maxcare.fHDNhanTinFollowers));
			...
			bunifuCustomLabel1.Text = "Cấu hình Nhă\u0301n tin Followers";
