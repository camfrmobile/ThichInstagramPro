...
namespace maxcare
{
	public class fHDFollowBackFollower : Form
	{
		...
		public fHDFollowBackFollower(string id_KichBan, int type = 0, string id_HanhDong = "")
		{
			InitializeComponent();
			ChangeLanguage();
			isSave = false;
			...
			string text2 = "Follow lại followers";
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(maxcare.fHDFollowBackFollower));
			...
			bunifuCustomLabel1.Text = "Cấu hình Follow lại followers";
			...
			base.Name = "fHDFollowBackFollower";
