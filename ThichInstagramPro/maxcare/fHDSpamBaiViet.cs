	...
	public class fHDSpamBaiViet : Form
	{
		...
		private void txtUid_TextChanged(object sender, EventArgs e)
		{
			try
			{
				List<string> lst = txtUid.Lines.ToList();
				lst = MCommon.Common.RemoveEmptyItems(lst);
				label10.Text = string.Format(Language.GetValue("Nhập danh sách User ({0}):"), lst.Count.ToString());
			}
			catch
			{
			}
		...
		private void InitializeComponent()
		{
			...
			panel1.Name = "panel1";
			panel1.Size = new System.Drawing.Size(683, 383);
			panel1.TabIndex = 0;
			...
			ckbInteract.Location = new System.Drawing.Point(352, 77);
			...
			plComment.Location = new System.Drawing.Point(370, 127);
			plComment.Name = "plComment";
			plComment.Size = new System.Drawing.Size(281, 193);
			plComment.TabIndex = 10;
			label8.AutoSize = true;
			label8.Location = new System.Drawing.Point(4, 172);
			label8.Name = "label8";
			...
			txtComment.Size = new System.Drawing.Size(263, 144);
			...
			label10.Size = new System.Drawing.Size(155, 16);
			label10.TabIndex = 116;
			label10.Text = "Nhập danh sách User (0):";
			...
			label19.Text = "Sô\u0301 ba\u0300i viết/User:";
			ckbComment.AutoSize = true;
			ckbComment.Cursor = System.Windows.Forms.Cursors.Hand;
			ckbComment.Location = new System.Drawing.Point(352, 103);
			...
			nudSoLuongBaiVietTo.Location = new System.Drawing.Point(232, 78);
			...
			nudSoLuongBaiVietFrom.Location = new System.Drawing.Point(135, 78);
			...
			btnCancel.Location = new System.Drawing.Point(352, 341);
			...
			btnAdd.Location = new System.Drawing.Point(245, 341);
			btnAdd.Name = "btnAdd";
			...
			base.ClientSize = new System.Drawing.Size(683, 383);
