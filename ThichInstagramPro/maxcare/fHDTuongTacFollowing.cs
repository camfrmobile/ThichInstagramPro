...
namespace maxcare
{
	public class fHDTuongTacFollowing : Form
	{
		...
		public fHDTuongTacFollowing(string id_KichBan, int type = 0, string id_HanhDong = "")
		{
			InitializeComponent();
			ChangeLanguage();
			isSave = false;
			...
			string text2 = "Tương tác Following";
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(maxcare.fHDTuongTacFollowing));
			...
			bunifuCustomLabel1.Text = "Cấu hình Tương tác Following";
			...
			ckbComment.Location = new System.Drawing.Point(10, 83);
			...
			base.Name = "fHDTuongTacFollowing";
