...
namespace maxcare
{
	public class fNhapTokenTrungGian_DownAvatar : Form
	{
		...
		{
			settings.Update("token", token.Text);
			settings.Update("pathFolderAvatar", txtPathFolder.Text);
			settings.Save();
			isOK = true;
			Close();
		}
		...
		{
			token.Text = settings.GetValue("token");
			txtPathFolder.Text = settings.GetValue("pathFolderAvatar");
		}

		private void btnCheckLiveTokenTg_Click(object sender, EventArgs e)
		{
			if (CommonRequest.CheckLiveToken("", token.Text, "", ""))
			{
				MessageBoxHelper.ShowMessageBox("Token live!");
			}
			else
			{
				MessageBoxHelper.ShowMessageBox("Token die!");
			}
		}

		private void metroButton1_Click(object sender, EventArgs e)
		{
			txtPathFolder.Text = MCommon.Common.SelectFolder();
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(maxcare.fNhapTokenTrungGian_DownAvatar));
			...
			btnCancel.Location = new System.Drawing.Point(230, 144);
			...
			btnAdd.Location = new System.Drawing.Point(126, 144);
			btnAdd.Name = "btnAdd";
			...
			metroButton1.Location = new System.Drawing.Point(349, 94);
			...
			txtPathFolder.Location = new System.Drawing.Point(147, 94);
			...
			label1.Location = new System.Drawing.Point(31, 97);
			label1.Name = "label1";
			label1.Size = new System.Drawing.Size(94, 16);
			label1.TabIndex = 36;
			label1.Text = "Nơi lưu Avatar:";
			base.AutoScaleDimensions = new System.Drawing.SizeF(6f, 13f);
			base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			base.ClientSize = new System.Drawing.Size(449, 191);
