...
namespace maxcare
{
	public class fDoiThongTin : Form
	{
		...
		private ToolStripMenuItem fgrdgToolStripMenuItem;
		...
		private void ExcuteOneThread(int indexRow, int indexPos, bool isRunSwap, string pathLD)
		{
			...
			try
			{
				...
				else
				{
					while (true)
					{
						...
						bool valueBool = setting_InteractGeneral.GetValueBool("ckbBio");
						List<string> valueList = setting_InteractGeneral.GetValueList("txtNoiDung");
						setting_InteractGeneral.GetValueBool("ckbWedsite");
						setting_InteractGeneral.GetValueList("txtWedsite");
						bool valueBool2 = setting_InteractGeneral.GetValueBool("ckbNgaySinh");
						int num7 = rd.Next(setting_InteractGeneral.GetValueInt("nudDayFrom"), setting_InteractGeneral.GetValueInt("nudDayTo") + 1);
						rd.Next(setting_InteractGeneral.GetValueInt("nudThangFrom"), setting_InteractGeneral.GetValueInt("nudThangTo") + 1);
						rd.Next(setting_InteractGeneral.GetValueInt("nudNamFrom"), setting_InteractGeneral.GetValueInt("nudNamTo") + 1);
						bool valueBool3 = setting_InteractGeneral.GetValueBool("ckbGioiTinh");
						bool valueBool4 = setting_InteractGeneral.GetValueBool("rbNam");
						bool valueBool5 = setting_InteractGeneral.GetValueBool("rbNothing");
						bool valueBool6 = setting_InteractGeneral.GetValueBool("rbNu");
						bool valueBool7 = setting_InteractGeneral.GetValueBool("ckbXoaNguyenLieuDaDung");
						bool valueBool8 = setting_InteractGeneral.GetValueBool("rbRandomGender");
						new List<string>();
						if (!valueBool7)
						{
							CloneList(lstNoiDung);
						}
						new List<string>
						{
						...
						try
						{
							...
							while (true)
							{
								...
								if (!device.CheckExistText("search and explore", "", 10.0) || !device.TapByText("\"profile\"", "", 10) || !device.TapByImage("DataClick\\image\\nutEditProfile", null, 10))
								{
									break;
								}
								flag8 = device.CheckExistText("change profile photo", "", 10.0);
								while (flag8)
								{
									num8++;
									switch (num8)
									...
									case 2:
									{
										...
										for (int n = 0; n < 2; n++)
										{
											if (device.ScrollAndCheckScreenNotChange(1000, -1))
											{
												break;
											}
										}
										device.TapByBounds("[114,361][168,375]");
										while (!device.CheckExistText("150", "", 2.0))
										{
										...
										device.DelayTime(1.0);
										device.InputTextWithUnicode(valueList[rd.Next(0, valueList.Count())]);
										device.DelayTime(1.0);
										device.TapByText("done", "", 2);
									...
									case 4:
										...
										if (device.TapByText("personal information settings", "", 10) && device.CheckExistText("personal information", "", 10.0))
										{
											device.TapByBounds("[55,255][148,267]");
											device.DelayTime(2.0);
											if (valueBool8)
											{
												switch (rd.Next(1, 4))
												{
												case 1:
													device.TapByText("\"male\"");
													break;
												case 2:
													device.TapByText("\"female\"");
													break;
												case 3:
													device.TapByText("\"prefer not to say\"");
													break;
												}
											}
											else if (valueBool4)
											...
											{
												flag8 = device.CheckExistText("personal information", "", 10.0);
											}
										}
										device.GotoBack();
										continue;
									case 5:
									{
										if (!valueBool2 || !device.TapByText("personal information settings", "", 10) || !device.TapByText("personal information", "", 10))
										{
											continue;
										}
										device.TapByBounds("[96,309][150,322]");
										device.DelayTime(2.0);
										if (device.CheckExistText("you cannot update your age", "", 2.0))
										{
											continue;
										}
										List<string> listText = device.GetListText();
										int num11 = Convert.ToInt32(listText.First().Split(' ', ',')[1].ToString());
										int num12 = 0;
										if (num11 > num7)
										{
											num12 = num11 - num7;
											...
											{
												device.Swipe(164, 378, 164, 425, 500);
											}
										}
										else if (num11 < num7)
										{
											...
											{
												device.Swipe(164, 425, 164, 378, 500);
											}
										}
										continue;
									}
			...
			try
			{
				int num14 = rd.Next(setting_general.GetValueInt("nudDelayCloseDeviceFrom"), setting_general.GetValueInt("nudDelayCloseDeviceTo") + 1);
				if (num14 > 0)
				{
					int tickCount2 = Environment.TickCount;
					while ((Environment.TickCount - tickCount2) / 1000 - num14 < 0)
					{
						if (!isStop)
						{
							SetStatusAccount(indexRow, text2 + Language.GetValue("Đóng LD sau {time}s...").Replace("{time}", (num14 - (Environment.TickCount - tickCount2) / 1000).ToString()));
							MCommon.Common.DelayTime(0.5);
							continue;
						}
						SetStatusAccount(indexRow, text2 + Language.GetValue("Đã dừng!"));
		...
		{
			setting_general = new JSON_Settings("configGeneral");
			setting_InteractGeneral = new JSON_Settings("configDoiThongTin");
		}
		...
		{
			MCommon.Common.ShowForm(new fDoiThongTin_CauHinh());
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(maxcare.fDoiThongTin));
			...
			fgrdgToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			ctmsAcc.Size = new System.Drawing.Size(181, 224);
			...
			chọnLiveToolStripMenuItem.Size = new System.Drawing.Size(180, 22);
			...
			bỏChọnTấtCảToolStripMenuItem.Size = new System.Drawing.Size(180, 22);
			...
			copyToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[9] { uidToolStripMenuItem, passToolStripMenuItem, cookieToolStripMenuItem, mailToolStripMenuItem, uidPassToolStripMenuItem, uidPass2FaToolStripMenuItem, useragentToolStripMenuItem1, proxyToolStripMenuItem1, đinhDangKhacToolStripMenuItem });
			...
			uidToolStripMenuItem.Size = new System.Drawing.Size(180, 22);
			...
			passToolStripMenuItem.Size = new System.Drawing.Size(180, 22);
			...
			cookieToolStripMenuItem.Size = new System.Drawing.Size(180, 22);
			...
			mailToolStripMenuItem.Size = new System.Drawing.Size(180, 22);
			...
			uidPassToolStripMenuItem.Size = new System.Drawing.Size(180, 22);
			...
			uidPass2FaToolStripMenuItem.Size = new System.Drawing.Size(180, 22);
			...
			useragentToolStripMenuItem1.Size = new System.Drawing.Size(180, 22);
			...
			proxyToolStripMenuItem1.Size = new System.Drawing.Size(180, 22);
			...
			đinhDangKhacToolStripMenuItem.Size = new System.Drawing.Size(180, 22);
			...
			xóaTàiKhoảnToolStripMenuItem.Size = new System.Drawing.Size(180, 22);
			...
			câpNhâtThôngTinCaNhânToolStripMenuItem.Size = new System.Drawing.Size(180, 22);
			...
			chuyểnThưMụcToolStripMenuItem.Size = new System.Drawing.Size(180, 22);
			...
			chứcNăngToolStripMenuItem1.Size = new System.Drawing.Size(180, 22);
			...
			tảiLạiDanhSáchToolStripMenuItem.Size = new System.Drawing.Size(180, 22);
			...
			bunifuCustomLabel1.Size = new System.Drawing.Size(324, 16);
			bunifuCustomLabel1.TabIndex = 3;
			bunifuCustomLabel1.Text = "MAX SYSTEM CARE PRO - Ti\u0301nh năng Đổi thông tin";
			...
			thoátToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[1] { fgrdgToolStripMenuItem });
			...
			fgrdgToolStripMenuItem.Name = "fgrdgToolStripMenuItem";
			fgrdgToolStripMenuItem.Size = new System.Drawing.Size(106, 22);
			fgrdgToolStripMenuItem.Text = "fgrdg";
