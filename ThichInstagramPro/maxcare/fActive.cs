...
namespace maxcare
{
	public class fActive : Form
	{
		...
		private void BtnLogin_Click(object sender, EventArgs e)
		{
			...
			new Thread((ThreadStart)delegate
			{
				...
				try
				{
					...
					string plaintext = text + "|" + text2 + "|" + 62 + "|" + num + "|code1";
		...
		private void InitializeComponent()
		{
			...
			bunifuCustomLabel1.Size = new System.Drawing.Size(294, 16);
			bunifuCustomLabel1.TabIndex = 7;
			bunifuCustomLabel1.Text = "MAX INSTAGRAM PRO - Kích hoạt bản quyền";
			...
			Text = "MAX INSTAGRAM PRO - Kích hoạt bản quyền";
