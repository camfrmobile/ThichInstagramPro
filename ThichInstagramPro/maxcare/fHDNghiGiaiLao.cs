...
namespace maxcare
{
	public class fHDNghiGiaiLao : Form
	{
		...
		public fHDNghiGiaiLao(string id_KichBan, int type = 0, string id_HanhDong = "")
		{
			...
			this.type = type;
			if (InteractSQL.GetTuongTac("", "HDNghiGiaiLao").Rows.Count == 0)
			{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(maxcare.fHDNghiGiaiLao));
			...
			bunifuCustomLabel1.Text = "Cấu hình Nghỉ giải lao";
			...
			nudDelayTo.Location = new System.Drawing.Point(229, 78);
			...
			btnCancel.Location = new System.Drawing.Point(189, 116);
