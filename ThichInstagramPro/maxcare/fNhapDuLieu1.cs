...
namespace maxcare
{
	public class fNhapDuLieu1 : Form
	{
		...
		public fNhapDuLieu1(string linkPath, string title = "Nhập danh sách Uid cần clone", string status = "Danh sách Uid", string footer = "(Mỗi nội dung 1 dòng, spin nội dung {a|b|c})")
		{
			InitializeComponent();
			ChangeLanguage();
